# Generated by Django 3.0.2 on 2020-01-23 09:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_names', models.TextField(blank=True, help_text='Fields that will be in all of this type (other than date/notes).  Spearate items by a newline.  Limited to 500 characters.', max_length=500, verbose_name='Field names')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fields', models.TextField(blank=True, max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='sample_database.Piece')),
        ...
        migrations.AddField(
            model_name='data',
            name='data_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sample_database.Data_Type'),
        ),
        migrations.CreateModel(
            name='Action',
            fields=[
                ...
                ('action_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sample_database.Action_Type')),
                ('last_modified_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='action_edited', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('pieces', models.ManyToManyField(to='sample_database.Piece')),
            ],
        ),
        migrations.CreateModel(
